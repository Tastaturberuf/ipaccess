 ...
 */
$GLOBALS['TL_MODELS']['tl_ipaccess'] = 'ipaccess\IpAccessModel';
 ...
 */
$GLOBALS['TL_CRON']['hourly'][] = array('IpAccess', 'updateAllIps');
 ...
 */
$GLOBALS['TL_HOOKS']['initializeSystem'][] = array('IpAccess', 'initializeSystem');
